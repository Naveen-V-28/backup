                    ...
                    <PreviewCard className='pt-4'>
                        ...
                        <Row className="gy-4 text-center ">
                            ...
                            <Col md="6" lg='3' >
                                <Link to={process.env.PUBLIC_URL + "twowheeler"}>
                                    <div className="custom-control-group custom-control custom-radio custom-control-pro no-control">
                                        <input type="radio" value="two-wheeler" className="custom-control-input" name="btnCheck" id="btnCheck2" />
                            ...
                            <Col md="6" lg='3'>
                                <Link to={process.env.PUBLIC_URL + "gcv"}>
                                    <div className="custom-control-group custom-control custom-radio custom-control-pro no-control">
                                        <input type="radio" value="gcv" className="custom-control-input" name="btnCheck" id="btnCheck3" />
                            ...
                            <Col md="6" lg='3'>
                                <Link to={process.env.PUBLIC_URL + "pcv"}>
                                    <div className=" custom-control-group custom-control custom-radio custom-control-pro no-control ">
                                        <input type="radio" value="pcv" className="custom-control-input" name="btnCheck" id="btnCheck4" />
                        ...
                        <Row className="gy-4 mt-4 text-center">
                            ...
                            <Col md="6" lg='3'>
                                ...
                                <div className="custom-control-group custom-control custom-radio custom-control-pro no-control ">
                                    <input type="radio" value="health" className="custom-control-input" name="btnCheck" id="btnCheck5" />
                            ...
                            <Col md="6" lg='3'>
                                ...
                                <div className="custom-control-group custom-control custom-radio custom-control-pro no-control">
                                    <input type="radio" value="life" className="custom-control-input" name="btnCheck" id="btnCheck6" />
                            ...
                            <Col md="6" lg='3'>
                                ...
                                <div className=" custom-control-groupcustom-control custom-radio custom-control-pro no-control ">
                                    <input type="radio" value="personal-accident" className="custom-control-input" name="btnCheck" id="btnCheck7" />
                            ...
                            <Col md="6" lg='3'>
                                ...
                                <div className="custom-control-group custom-control custom-radio custom-control-pro no-control">
                                    <input type="radio" value="others" className="custom-control-input" name="btnCheck" id="btnCheck8" />
